...
import com.gdcp.yueyunku_client.utils.WindowUtils;
...
public class ViewPageAdapter extends PagerAdapter {
    ...
    private class MyTarget extends SimpleTarget<Bitmap> {
        ...
        public void onResourceReady(Bitmap resource, GlideAnimation<? super Bitmap> glideAnimation) {
            ...
            int screenWidth = WindowUtils.getInstance().getScreenWidth((Activity) context);
            int screenHeight = WindowUtils.getInstance().getScreenHeight((Activity) context);
